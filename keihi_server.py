        ...
        response = client.messages.create(
            ...
            messages=[{
                ...
                "content": [
                    ...
                    {"type": "text", "text": "この画像またはPDFは領収書・レシート・経費精算書です。内容を読み取り、以下のJSON形式で返してください。金額が複数ある場合は合計金額を使ってください。店名が書いていない場合はファイルの内容から推測してください。{\"店名\": \"\", \"日付\": \"\", \"金額\": 0, \"カテゴリ\": \"\", \"支払方法\": \"\", \"備考\": \"\"}。JSONのみ返してください。"}
                ]
            }]
        )
